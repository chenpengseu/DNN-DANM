clear all; close all;
get_SNR_RMSE_phase('fft');
get_SNR_RMSE_phase('omp');
get_SNR_RMSE_phase('fft-denoise');
get_SNR_RMSE_phase('omp-denoise');
% get_SNR_RMSE_phase('omp-denoise-anm');
% get_SNR_RMSE_phase('omp-denoise-danm');
get_SNR_RMSE_phase('prony-denoise-danm'); 
