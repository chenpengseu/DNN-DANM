clear all; close all;
% get_SNR_RMSE_performance('fft');
% get_SNR_RMSE_performance('omp');
% get_SNR_RMSE_performance('fft-denoise');
% get_SNR_RMSE_performance('omp-denoise');
% get_SNR_RMSE_performance('omp-denoise-anm');
% get_SNR_RMSE_performance('omp-denoise-danm');
get_SNR_RMSE_performance('prony-denoise-danm'); 
